        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <button
              ...
              className={`text-sm font-medium transition-colors duration-200 ${
                activeItem === 'about' ? 'text-custom-color-1' : 'text-gray-300 hover:text-white'
              }`}
            >
              O nás
            </button>
            <button
              ...
              onMouseLeave={() => setActiveItem(null)}
              className={`text-sm font-medium transition-colors duration-200 ${
                activeItem === 'products' ? 'text-custom-color-2' : 'text-gray-300 hover:text-white'
              }`}
            >
              Služby
            </button>
            <button
              ...
              onMouseLeave={() => setActiveItem(null)}
              className={`text-sm font-medium transition-colors duration-200 ${
                activeItem === 'projects' ? 'text-custom-color-3' : 'text-gray-300 hover:text-white'
              }`}
            >
              Projekty
            </button>
            <button
              ...
              onMouseLeave={() => setActiveItem(null)}
              className={`text-sm font-medium transition-colors duration-200 ${
                activeItem === 'contact' ? 'text-custom-color-4' : 'text-gray-300 hover:text-white'
              }`}
            >
              Kontakt
            </button>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden lg:flex items-center space-x-3">
              <Button size="icon" className="w-8 h-8 bg-custom-color-2 hover:bg-custom-color-1 text-white rounded-full hover:scale-110 transition-all duration-300">
              ...
              <Button size="icon" className="w-8 h-8 bg-custom-color-5 hover:bg-custom-color-3 text-white rounded-full hover:scale-110 transition-all duration-300">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
