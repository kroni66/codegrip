...
export const HeroSection = () => {
    ...
    const scrollToSection = (sectionId: string) => {
        ...
        setMenuState(false); // Close mobile menu after navigation
    };
        ...
        <div>
            ...
            <main>
                ...
                <section className="overflow-hidden bg-white dark:bg-transparent">
                    <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-24">
                        <div className="relative z-10 mx-auto max-w-2xl text-center">
                            <h1 className="text-balance text-4xl font-semibold md:text-5xl lg:text-6xl">Moderní webové řešení pro vaši značku</h1>
                            <p className="mx-auto my-8 max-w-2xl text-xl text-muted-foreground">Specializujeme se na tvorbu moderních webových aplikací, e-shopů a digitálních řešení. Pomáháme firmám růst prostřednictvím inovativních technologií.</p>

                            <Button
                                onClick={() => scrollToSection('footer')}
                                size="lg">
                                <span className="btn-label">Začněte stavět</span>
                            </Button>
                        </div>
                    </div>
                ...
                <section className="bg-background relative z-10 py-16">
                    <div className="m-auto max-w-5xl px-6">
                        <h2 className="text-center text-lg font-medium">Vaše oblíbené společnosti jsou našimi partnery.</h2>
