...
import { Home as HomeIcon, FileText, CreditCard, Info, Sparkles } from 'lucide-react';
...
import { SilvusShaderBackground } from './components/SilvusShaderBackground'

const navItems = [
  { name: 'Home', url: '#', icon: HomeIcon },
  { name: 'O nás', url: '#about', icon: FileText },
  { name: 'Služby', url: '#services-heading', icon: CreditCard },
  { name: 'Silvus AI', url: '#silvus-ai', icon: Sparkles },
